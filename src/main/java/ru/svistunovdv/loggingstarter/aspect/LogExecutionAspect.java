package ru.svistunovdv.loggingstarter.aspect;
...
import ru.svistunovdv.loggingstarter.annotation.LogExecutionTime;
...
public class LogExecutionAspect {
    ...
    @Around("@annotation(ru.svistunovdv.loggingstarter.annotation.LogExecutionTime)")
